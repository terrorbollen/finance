...
| `backtesting/` | `backtesting/backtester.py`, `backtesting/metrics.py`, `backtesting/results.py`, `backtesting/portfolio.py` | — |
| `main.py` | `main.py` | — |
